...
CREATE TABLE `evenimente` (
  ...
  `artisti` varchar(200) NOT NULL,
  `dataeveniment` varchar(45) NOT NULL,
  `oraeveniment` varchar(45) NOT NULL,
  `idlocatie` int NOT NULL,
  `nrbileteramase` int NOT NULL,
  PRIMARY KEY (`ideveniment`),
  KEY `idlocatie` (`idlocatie`),
  CONSTRAINT `evenimente_ibfk_1` FOREIGN KEY (`idlocatie`) REFERENCES `locatii` (`idlocatie`)
...
INSERT INTO `evenimente` VALUES (2,'Festivalul Luminii','[, Nane, Metalica, Altii]','2022-06-10','16:00:00',2,4000);
